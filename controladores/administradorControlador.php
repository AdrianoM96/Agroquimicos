<?php
	...
	class administradorControlador extends administradorModelo{
		...
		public function paginador_administrador_controlador($pagina,$registros,$privilegio,$codigo,$busqueda){//numero de pagina,cantidad de registros que se meustran,privilegio para poder eliminar y editar si tiene priv 1,codigo del superadmin,
			...
			$pagina = (isset($pagina) && $pagina>0) ? (int) $pagina : 1;//si viene definida yes mayor que 0,SINO ,le asigno 1
			$inicio = ($pagina>0) ? (($pagina * $registros)-$registros) : 0;//establezco de que registro empezar cada pagina,0 porque los array empiezan desde 0
			...
			$Npaginas =ceil($total/$registros);//toma el entero de la operacion
