...
<div class="container-fluid">
	<div class="panel panel-info">
		<div class="panel-heading">
			<h3 class="panel-title"><i class="zmdi zmdi-plus"></i> &nbsp; NUEVO PRODUCTOR AGROPECUARIO</h3>
		</div>
		<div class="panel-body">
			<form class="FormularioAjax" method="POST" action="<?php echo SERVERURL; ?>ajax/productorAjax.php" data-form="save" enctype="multipart/form-data" autocomplete="off">
		    	<fieldset>
		    			...
		    			<div class="row">
		    				<div class="col-xs-12">
						    	<div class="form-group label-floating">
								  	...
								  	<input pattern="[0-9-]{8,30}" class="form-control" type="text" name="cuit-reg" required="" maxlength="30">
								</div>
		    				</div>
